    ...
    return (
        <div className="main-container-book">
            ...
            <div class="flex flex-row">
                ...
                <div className="basis-1/2 bg-white mt-2 w-100 mr-3 ml-10 " style={{ hight: "45%" }}>
                    <div className="">
                        <table className="table-auto border border-black ml-5 mt-2 ">
                            <thead>
                                <tr>
                                    <td className="border border-black p-2 text-center" style={{ width: "20%" }}>First</td>
                                    <td className="border border-black p-2 text-center" style={{ width: "20%" }}>Agent Last Name</td>
                                    <td className="border border-black p-2 text-center" style={{ width: "20%" }}>Company</td>
                                    <td className="border border-black p-2 text-center" style={{ width: "20%" }}>Work</td>
            ...
            <div className="btn-conat-book ml-5 ">
                ...
                <div className="flex gap-1 mt-2 ml-2">
                    <button className="border border-black bg-gray-300 hover:bg-blue-100 h-6 rounded" style={{ width: "24%" }} >
                ...
                <div className="flex gap-1 mt-2 ml-2">
                    <button className="border border-black bg-gray-300 hover:bg-blue-100  h-6 rounded" style={{ width: "48.5%" }}>
                        Import Contacts
                    </button>
                </div>
           </div>
